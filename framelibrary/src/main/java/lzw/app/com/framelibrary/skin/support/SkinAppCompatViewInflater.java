package lzw.app.com.framelibrary.skin.support;
...
public class SkinAppCompatViewInflater {
    ...
    public final View createView(View parent,
                                 String name,
    ...
    private View createViewFromTag(Context context, String name, AttributeSet attrs) {
        ...
        try {
            ...
            if (-1 != name.indexOf(46)) {
                var12 = this.createViewByPrefix(context, name, (String) null);
                return var12;
            }
    ...
    private static Context themifyContext(Context context, AttributeSet attrs, boolean useAndroidTheme, boolean useAppTheme) {
        TypedArray a = ((Context) context).obtainStyledAttributes(attrs, android.support.v7.appcompat.R.styleable.View, 0, 0);
        int themeId = 0;
        if (useAndroidTheme) {
